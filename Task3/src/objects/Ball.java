...
public class Ball implements Sprite {
    ...
    /**
     * Sets game screen edge.
     *
     * @param wEdge the width edge
     * @param hEdge the height edge
     */
    public void setEdge(int wEdge, int hEdge) {
        this.wEdge = wEdge;
        this.hEdge = hEdge;
    }
    ...
    public void moveOneStep() {
        Point destination = new Point(this.getX() + velocity.getDX(),
                this.getY() + velocity.getDY());
        ...
        if (collision != null) {
            ...
            if (Math.abs(collisionPoint.getY() - topLeft.getY()) < EPSILON) {
                this.center = new Point(this.getX(), collisionPoint.getY()
                        - this.radius);
            }
            ...
            this.velocity = collision.collisionObject().hit(collision
                    .collisionPoint(), getVelocity());
        }
